...
def detect_gesture(landmarks, handedness):
    ...
    # Debugging output
    print(f"Fingers: {fingers}, Handedness: {handedness}")
...
while cap.isOpened():
    ...
    p_time=time.time()
    cv2.putText(img, f'FPS: {int(fps)} | Hand: {handedness} | Gesture: {gesture}', (10, 30), cv2.FONT_HERSHEY_SIMPLEX, 1, (255, 0, 0), 2)
